...
async def run(app, user_message: str, pdf_path: str = None, thread_id: str = None) -> str:
    ...
    result = await app.ainvoke(initial_state(user_message, pdf_path), config=thread_config)
